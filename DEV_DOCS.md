# 📘 CareerFlow — Полная документация разработчика
...
**CareerFlow** — это интеллектуальный карьерный навигатор для компании МТС, реализованный в формате **Telegram Mini App**.
